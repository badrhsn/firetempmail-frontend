...
const platforms = [
    // --- Streaming ---
    { platform: "Netflix", category: "Streaming", blocks_temp_mail: true, reason: "protect your real email and reduce promotional spam", difficulty: "medium",
      verification_time_seconds: 22, success_rate: "67%", test_date: "2026-04-10", domains_tested: 3 },
    { platform: "Spotify", category: "Streaming", blocks_temp_mail: false, reason: "reduce promotional email and keep your inbox organized", difficulty: "easy",
      verification_time_seconds: 8, success_rate: "100%", test_date: "2026-04-10", domains_tested: 3 },
    { platform: "Disney Plus", category: "Streaming", blocks_temp_mail: true, reason: "keep your personal inbox private during signup", difficulty: "medium",
    ...
    { platform: "YouTube", category: "Streaming", blocks_temp_mail: false, reason: "separate creator experiments from your primary inbox", difficulty: "easy",
    ...
    { platform: "Crunchyroll", category: "Streaming", blocks_temp_mail: false, reason: "protect your inbox from anime promo campaigns", difficulty: "easy",
    ...
    { platform: "Twitter", category: "Social", blocks_temp_mail: false, reason: "keep your social signup separate from your main inbox", difficulty: "easy",
    ...
    { platform: "Tumblr", category: "Social", blocks_temp_mail: false, reason: "start a separate blogging profile with inbox privacy", difficulty: "easy",
      verification_time_seconds: 6, success_rate: "100%", test_date: "2026-04-12", domains_tested: 2 },
    { platform: "Patreon", category: "Social", blocks_temp_mail: false, reason: "explore creator pages without exposing your primary inbox", difficulty: "easy",
      verification_time_seconds: 9, success_rate: "100%", test_date: "2026-04-12", domains_tested: 2 },
    ...
    { platform: "Telegram", category: "Social", blocks_temp_mail: false, reason: "set up Telegram with better inbox privacy", difficulty: "easy",
    ...
    { platform: "Snapchat", category: "Social", blocks_temp_mail: false, reason: "separate Snapchat experiments from your main inbox", difficulty: "easy",
      verification_time_seconds: 8, success_rate: "100%", test_date: "2026-04-12", domains_tested: 2 },

    // --- Gaming ---
    { platform: "Steam", category: "Gaming", blocks_temp_mail: false, reason: "separate game testing profiles from your primary inbox", difficulty: "easy",
      verification_time_seconds: 10, success_rate: "100%", test_date: "2026-04-10", domains_tested: 3 },
    ...
    { platform: "Roblox", category: "Gaming", blocks_temp_mail: false, reason: "test new-player onboarding with a separate profile", difficulty: "easy",
      verification_time_seconds: 6, success_rate: "100%", test_date: "2026-04-11", domains_tested: 3 },
    ...
    { platform: "PlayStation", category: "Gaming", blocks_temp_mail: false, reason: "avoid spam from sony", difficulty: "easy",
      verification_time_seconds: 14, success_rate: "100%", test_date: "2026-04-12", domains_tested: 2 },
    { platform: "Fortnite", category: "Gaming", blocks_temp_mail: false, reason: "keep Fortnite signups separate from your main inbox", difficulty: "easy",
    ...
    { platform: "Canva", category: "Tech", blocks_temp_mail: false, reason: "evaluate Canva features while controlling promotional email", difficulty: "easy",
      verification_time_seconds: 8, success_rate: "100%", test_date: "2026-04-11", domains_tested: 3 },
    ...
    { platform: "Proton VPN", category: "Tech", blocks_temp_mail: false, reason: "sign up for VPN tools without exposing your primary inbox", difficulty: "easy",
    ...
    // --- AI Tools ---
    { platform: "ChatGPT", category: "AI Tools", blocks_temp_mail: false, reason: "test AI workflows while protecting your primary inbox", difficulty: "easy",
      verification_time_seconds: 8, success_rate: "100%", test_date: "2026-04-10", domains_tested: 3 },
    { platform: "Midjourney", category: "AI Tools", blocks_temp_mail: false, reason: "evaluate AI image workflows without inbox clutter", difficulty: "easy",
      verification_time_seconds: 10, success_rate: "100%", test_date: "2026-04-10", domains_tested: 3 },
    ...
    { platform: "Grok", category: "AI Tools", blocks_temp_mail: false, reason: "access xAI without spam", difficulty: "easy",
      verification_time_seconds: 7, success_rate: "100%", test_date: "2026-04-12", domains_tested: 2 },
    { platform: "DeepSeek", category: "AI Tools", blocks_temp_mail: false, reason: "register while protecting your primary inbox", difficulty: "easy",
      verification_time_seconds: 6, success_rate: "100%", test_date: "2026-04-12", domains_tested: 2 },
