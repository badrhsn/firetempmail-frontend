      ...
      <p class="lead">
        Protect your inbox and avoid spam with a <strong>burner email</strong>. Instantly generate a <strong>temporary disposable email</strong> for anonymous signups, trial accounts, or quick testing.
            ...
            <div class="email-address-container">
                ...
                <!-- Surfshark Alert Banner - Privacy Protection -->
                {#if address}
                <div class="surfshark-banner">
                    <div class="surfshark-content">
                        <div class="surfshark-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="surfshark-text">
                            <h3>🔒 Complete Your Privacy Protection</h3>
                            <p>You're protecting your email. Now monitor if your data was leaked in breaches with <strong>Surfshark Alert</strong></p>
                        </div>
...
<section class="mt-10 p-6 bg-gray-50 rounded-xl shadow-md">
  ...
  <div class="space-y-4">
    <details class="p-3 bg-white rounded-md shadow-sm">
      <summary class="cursor-pointer font-medium">What is a Burner Email?</summary>
      <p class="mt-2 text-gray-600">
        A burner email is a <strong>temporary, disposable email address</strong> you can use for online testing, signing up for websites, or receiving confirmation codes without exposing your main inbox.
      </p>
    </details>

    <details class="p-3 bg-white rounded-md shadow-sm">
      <summary class="cursor-pointer font-medium">How long does a burner email last?</summary>
      <p class="mt-2 text-gray-600">
        Burner emails generated on Fire Temp Mail usually last <strong>24–48 hours</strong>. After that, they are automatically deleted. You can generate a new temporary email anytime.
      </p>
    </details>

    <details class="p-3 bg-white rounded-md shadow-sm">
      <summary class="cursor-pointer font-medium">Is it safe to use a temporary email for signups?</summary>
      <p class="mt-2 text-gray-600">
        ✅ Yes. Using a <strong>disposable email</strong> is safe for newsletters, trial accounts, and temporary online services. Avoid using it for sensitive accounts like banking or personal identity services.
      </p>
    </details>

    <details class="p-3 bg-white rounded-md shadow-sm">
      <summary class="cursor-pointer font-medium">Can I use a burner email for Amazon, Netflix, or other subscriptions?</summary>
      <p class="mt-2 text-gray-600">
        Many users create <strong>temporary emails</strong> for testing subscriptions, accessing trial offers, or protecting their personal inbox. Remember, these <strong>burner inboxes</strong> are temporary and may not work for long-term account management.
      </p>
    </details>
  </div>
</section>
