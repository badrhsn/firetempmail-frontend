...
<Hreflang path="/" />
<svelte:head>
    <title>{data?.seo?.title || 'Fire Temp Mail - Privacy & Email Tips Blog'}</title>
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Fire Temp Mail - Privacy & Email Tips Blog" />
    ...
    <meta name="twitter:title" content="Fire Temp Mail - Privacy & Email Tips" />
