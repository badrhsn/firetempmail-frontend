...
<svelte:head>
    ...
    <meta name="keywords" content={data?.seo?.keywords || "temp mail, temporary email, disposable email, fake email, throwaway email, free temp mail"}>
    <meta name="robots" content="index, follow">
    <link rel="canonical" href={data?.seo?.canonical || 'https://firetempmail.com'}>
    <link rel="sitemap" type="application/xml" title="Sitemap" href="/sitemap.xml">

    <!-- Hreflang alternates -->
    <link rel="alternate" hreflang="en" href="https://firetempmail.com" />
    <link rel="alternate" hreflang="fr" href="https://firetempmail.com/fr" />
    <link rel="alternate" hreflang="de" href="https://firetempmail.com/de" />
    <link rel="alternate" hreflang="es" href="https://firetempmail.com/es" />
    <link rel="alternate" hreflang="it" href="https://firetempmail.com/it" />
    <link rel="alternate" hreflang="pt" href="https://firetempmail.com/pt" />
    <link rel="alternate" hreflang="nl" href="https://firetempmail.com/nl" />
    <link rel="alternate" hreflang="pl" href="https://firetempmail.com/pl" />
    <link rel="alternate" hreflang="ar" href="https://firetempmail.com/ar" />
    <link rel="alternate" hreflang="ru" href="https://firetempmail.com/ru" />
    <link rel="alternate" hreflang="zh" href="https://firetempmail.com/zh" />
    <link rel="alternate" hreflang="x-default" href="https://firetempmail.com" />

    <!-- Open Graph -->
    <meta property="og:title" content={data?.seo?.title || 'Fire Temp Mail | Free Disposable Temporary Email Generator'} />
    <meta property="og:description" content={data?.seo?.description || 'Generate free temporary email addresses instantly. Protect your inbox from spam with disposable emails — no signup required.'} />
    ...
    <meta name="twitter:title" content={data?.seo?.title || 'Fire Temp Mail — Free Disposable Email Generator'} />
    <meta name="twitter:description" content={data?.seo?.description || 'Create temporary email addresses instantly. Free, secure, and no signup required.'} />
