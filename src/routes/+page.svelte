<script>
        ...
        if (confirm("Do you really want to permanently delete this email?")) {
            try {
                ...
                if (data.code === 200) {
                    ...
                    showToast(
                        "Error",
                        `Failed to delete email: ${data.msg}`,
                        "error",
                    );
                }
            } catch (error) {
    ...
    async function forwardEmail(email) {
        ...
        let emailKey = email.recipient + "-" + email.suffix;
        let forwardTo = prompt(
            "Please enter the email address you want to forward this email to:",
            "",
        );
        ...
        try {
            ...
            if (data.code === 200) {
                ...
                showToast(
                    "Error",
                    `Failed to forward email: ${data.msg}`,
                    "error",
                );
            }
        } catch (error) {
            ...
            showToast(
                "Error",
                "Failed to forward email. Please try again.",
                "error",
            );
        }
    }
...
<section class="py-4 py-xl-5">
    <div class="container">
        <div class="text-center p-4 p-lg-5">
            ...
            <p class="lead">
                Instantly generate a disposable Email Generator address. Keep
                your real email address private and your inbox clean from
            ...
            <div class="email-address-container">
                <div class="email-display">
                    ...
                    >
                        ...
                        {:else}
                            ...
                            >
                                <path
                                    d="M8 16H6C4.89543 16 4 15.1046 4 14V6C4 4.89543 4.89543 4 6 4H14C15.1046 4 16 4.89543 16 6V8M14 20H18C19.1046 20 20 19.1046 20 18V14C20 12.8954 19.1046 12 18 12H14C12.8954 12 12 12.8954 12 14V18C12 19.1046 12.8954 20 14 20Z"
                                    stroke="currentColor"
                                    stroke-width="2"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                ...
                <div class="email-action-buttons">
                    ...
                    <button
                        ...
                        on:click={toggleCustomAlias}
                        title="Use custom alias"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
            ...
            {#if showDomainSelector}
                <div
                    ...
                    on:click={() => (showDomainSelector = false)}
                >
                        ...
                        <div class="modal-body">
                            <div class="domain-options">
                                {#each availableDomains as domain}
                                    <div
                                        class="domain-option {currentDomain ===
                                        domain
                                            ? 'active'
                                            : ''}"
