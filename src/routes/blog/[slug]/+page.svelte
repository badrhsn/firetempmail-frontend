<script>
    ...
    // Use data instead of $page.data to avoid undefined errors
    export let data;
    
    // Create a safe reference to the post data
    $: post = data?.post;
    $: safePost = post || {
        title: 'Loading...',
    ...
    <section class="py-4 py-xl-5">
        <div class="container" style="max-width: 800px;">
            <div class="text-center p-4 p-lg-5">
                ...
                <p>{safePost.excerpt}</p>
                <a href="/blog">← Back to Blog</a>
            </div>
        </div>
    </section>
{:else}
    <!-- Post content when data is available -->
    <section class="py-4 py-xl-5">
        <div class="container" style="max-width: 800px;">
            <div class="text-center p-4 p-lg-5">
                <!-- Back button -->
