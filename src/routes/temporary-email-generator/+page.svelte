...
<section class="py-4 py-xl-5">
    ...
    || 'No content available'}
            ...
            <h2>Temporary Email Generator - Create Disposable Emails in Seconds</h2>
<p class="description">
    Our powerful temporary email generator creates instant disposable email addresses that work everywhere. Perfect for signups, verifications, and protecting your privacy—no registration or personal information required.
</p>
